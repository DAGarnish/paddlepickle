...
export const metadata = {
  title: "Premium Padel Holidays Spain & Portugal | Padel Pickle HQ",
  description: "Specialized padel tennis coaching camps, weekend breaks, and team retreats in sunny Marbella and Barcelona Coast. Tailored for UK players.",
};

export default function PadelHolidaysHubPage() {
  const padelDestinations = destinationsData.filter((d) => d.sport === "Padel" || d.sport === "Both");

  const breadcrumbLinks = [
    { name: "Home", url: "/" },
    { name: "Holidays", url: "/holidays" },
    { name: "Padel Holidays", url: "/holidays/padel" }
  ];
      ...
      <main className="flex-grow bg-[#F9F9F5] py-16 font-sans">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-3xl mx-auto text-center mt-6 mb-16">
            <span className="text-[#D4AF37] text-xs font-bold uppercase tracking-widest block mb-2">Padel Tennis Escapes</span>
            <h1 className="font-serif text-3xl md:text-5xl font-bold text-[#0C2318]">Padel Holidays Spain &amp; Portugal</h1>
            <p className="text-gray-500 text-sm mt-3 leading-relaxed">
              Accelerate your court transition, master the Bandeja overhead, and experience high-intensity matches under the Iberian sun.
            </p>
          </div>

          {/* Holiday listings */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-20">
            {padelDestinations.map((dest) => (
          ...
          <div className="bg-[#0C2318] text-white p-12 border border-[#D4AF37] text-center max-w-3xl mx-auto space-y-6">
            <h3 className="font-serif text-2xl font-bold text-[#D4AF37]">Custom British Group Packages</h3>
            <p className="text-gray-300 text-xs max-w-xl mx-auto leading-relaxed">
              Traveling with a team from Hurlingham, Chelsea, or your local club? We structure bespoke double tournaments, custom schedules, and complete luxury coach logistics.
            </p>
            <Link
              href="/quote"
