...
export default function VillaCourtsPage() {
  const service = courtServicesData.find((s) => s.type === "villas")!;

  const breadcrumbLinks = [
    { name: "Home", url: "/" },
    { name: "Court Builds", url: "/courts" },
    { name: "For Villas & Homeowners", url: "/courts/villas" }
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center mt-6 mb-20">
            <div className="lg:col-span-7 space-y-6">
              <span className="text-[#D4AF37] text-xs font-bold uppercase tracking-widest block">Private Estates</span>
              ...
              <p className="text-gray-600 text-sm leading-relaxed">
                Add an elite sporting amenity to your private property. We specialize in building low-acoustic, high-safety padel and pickleball courts that complement local villa architecture. We handle full planning assessments, groundwork, framework construction, and turf installation.
              </p>
              ...
              <div className="pt-4 flex gap-4">
                ...
                <button
                  onClick={() => alert("Downloading Villa Planning Specifications Handbook...")}
            ...
            <div className="lg:col-span-5 relative aspect-video lg:aspect-square bg-gray-200 border border-[#E2E1D9]">
              <img
                ...
                alt="Residential villa padel court installation details"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {service.process.map((step) => (
                <div key={step.step} className="space-y-3 relative">
                  <span className="font-serif text-5xl font-bold text-[#D4AF37]/45 block">{step.step}</span>
                  <h3 className="font-serif text-lg font-bold text-[#0C2318]">{step.title}</h3>
